...
import PopupWithACK from '../components/PopupWithACK';
...
api.getAllInfo()
  ...
  .then(api.serverResponseChecker);
...
const popupDeleteCard = new PopupWithACK('.popup_delete-card', submitCardDelete);
